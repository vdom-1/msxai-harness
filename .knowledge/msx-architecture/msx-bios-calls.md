...
Function: Tests whether the character of (HL) is the specified character
           if not, it generates SYNTAX ERROR, otherwise it goes to [CHRGTR](https://map.grauw.nl/resources/msxbios.php#CHRGTR) (#0010)
...
Input: A  - Slot ID, see [RDSLT](https://map.grauw.nl/resources/msxbios.php#RDSLT)
           HL - Address
           E  - Value
Registers: AF, BC, D
Remark   : See [RDSLT](https://map.grauw.nl/resources/msxbios.php#RDSLT)
...
Input: IY - High byte with slot ID, see [RDSLT](https://map.grauw.nl/resources/msxbios.php#RDSLT)
...
Address: #0028
Function: Returns the type of [DAC](https://map.grauw.nl/resources/msxsystemvars.php#DAC) (decimal accumulator)
Input: none ([VALTYP](https://map.grauw.nl/resources/msxsystemvars.php#VALTYP) contains the [DAC](https://map.grauw.nl/resources/msxsystemvars.php#DAC) type)
Output: Integer          - C = 1, S = 1 (*), Z = 0, P/V = 1
...
Remark   : The following is the calling sequence:
           RST #30
           DB destination slot ID, see [RDSLT](https://map.grauw.nl/resources/msxbios.php#RDSLT)
...
Input: See [INITXT](https://map.grauw.nl/resources/msxbios.php#INITXT)
Registers: All
...
```
A: value to write
When bit 7 is reset it shows the MSX 2+ start-up screen on boot, and counts and initialises the RAM.
```
